...
export function IncomeClassificationModal({
  ...
  return (
    <div data-ev-id="ev_0a0018ff14" className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" dir="rtl" onClick={onClose}>
      <div data-ev-id="ev_fa0d171924" className="bg-card rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
